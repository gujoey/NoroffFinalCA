			...
			<div>
				...
				<div className="[ contact ]">
					<form className="[ contact__form ]" ref="loginForm">
						...
						<input className="[ contact__input ]" type="text" name="message" ref="message" placeholder="message"/><br />
						<span className="[ contact__error ]">{this.props.messageErr}</span><br />

						<button className="[ contact__button ]" type="button" onClick={app.handleContactTerm}>Submit</button>
					</form>
				</div>
			</div>
		);
